function modelParameters = positionEstimatorTraining(training_data)
   ...
   % Store in modelParameters
    ...
    preprocessed_data = preprocessing(training_data, bin_group, 'EMA', alpha, 'nodebug');
...
function preprocessed_data = preprocessing(training_data, bin_group, filter_type, alpha, method)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
