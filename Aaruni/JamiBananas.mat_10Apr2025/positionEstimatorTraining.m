    ...
    for dir_idx = 1:directions
        ...
        for win_idx = 1:((stop_idx-start_idx)/bin_group)+1
            ...
            [reg_coeff_X, reg_coeff_Y, win_firing] = calc_reg_coeff(win_idx, time_division, labels, ...
                dir_idx, spikes_matrix, pca_threshold, time_interval, curr_X_pos, curr_Y_pos, 'lasso');
...
function [reg_coeff_X, reg_coeff_Y, filtered_firing ] = ...
    ...
    spikes_matrix, pca_thresh, time_interval, curr_X_pos, curr_Y_pos, method)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [~, score, ~] = perform_PCA(centered_win_firing, pca_thresh, 'nodebug');
